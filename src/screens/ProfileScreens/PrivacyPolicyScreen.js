    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <View style={{ flexDirection: 'row', height: 60, justifyContent: 'center', width: '100%', marginTop: 20, marginHorizontal: 15 }}>
                ...
                <Text style={{ color: 'black', fontSize: 22, fontFamily: Theme.FONT_FAMILY_BOLD, textAlign: 'center', }}>Privacy Policy</Text>

            </View>

            <ScrollView style={{ flex: 1, marginTop: 20 }}>

                <Image style={{ width: 175, height: 175, alignSelf: 'center' }} source={require('../../assets/images/privacy_policy_image.png')} />
