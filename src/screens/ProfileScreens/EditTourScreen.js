...
import {update_tour} from '../../services/Api';
...
const EditTourScreen = ({route}) => {
  ...
  const updatetour = () => {
    if (!Description || !Price) {
      ...
      formdata.append('tours_name', item?.tours_name);
      formdata.append('tours_description', Description);
      formdata.append('tours_users_id', userDetail?.user?.id);
      formdata.append('tours_latitude', item?.tours_latitude);
      formdata.append('tours_longitude', item?.tours_longitude);
      formdata.append('tours_location', item?.tours_location);
    ...
    <View style={{flex: 1, backgroundColor: '#fff'}}>
      ...
      <ScrollView
        ...
        <View style={{padding: 15}}>
          ...
          <TextInput
            style={[styles.inputStyl, {color: '#979797'}]}
            value={item?.tours_name}
