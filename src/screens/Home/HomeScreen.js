    ...
    return (
      <Pressable
        ...
        <ScrollView
          ...
          pagingEnabled
          horizontal
          style={{ width: Dimensions.get("screen").width, height: 200, backgroundColor: "#888" }}
        >
          {item?.tours_image_galleries?.map(((item, index) => {
            return (
              <Image key={index} source={{ uri: item?.tig_tours_image_name }} style={{ width: Dimensions.get("screen").width, height: 200 }} resizeMode="cover" />
            )
          }))}
        </ScrollView>
    ...
    <View
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {loading ? (
          ...
          <View
            style={{ flex: 1, justifyContent: 'center', alignItems: 'center', height: Dimensions.get("screen").height / 2 }}>
            <Text
              style={{
                justifyContent: 'center',
                fontSize: 16,
